        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-end">
          ...
          <div className="grid grid-cols-3 border border-sky-100 bg-white/90 shadow-sm">
            <div className="border-r border-sky-100 p-4">
              <div className="text-2xl font-semibold text-sky-950">{rwas?.length || 0}</div>
              <div className="mt-1 text-sm text-sky-900/60">链上资产</div>
            </div>
            <div className="border-r border-sky-100 p-4">
              <div className="text-2xl font-semibold text-sky-950">{published}</div>
      ...
      <section className="grid gap-4 border-b border-sky-100 bg-[linear-gradient(180deg,#f7fbfd_0%,#edf6fb_100%)] px-4 py-8 text-sky-950 sm:px-8 md:grid-cols-3">
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-sky-900/70">围绕真伪、稀缺性、历史意义与流通能力进行多层评估。</p>
          </div>
        </div>
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-sky-900/70">资产信息展示服务于后续第三方托管、保险与流通服务。</p>
          </div>
        </div>
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-sky-900/70">通过 Token ID 与文件包 hash 记录资产核心索引。</p>
          </div>
        </div>
      </section>
            ...
            >
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="text-xs font-semibold text-sky-700">RWA #{rwa.tokenId.toString()}</div>
                      <h3 className="mt-2 text-xl font-semibold text-sky-950">{rwa.asset.name}</h3>
                    </div>
