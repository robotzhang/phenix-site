...
import { ArrowLeft, ExternalLink, FileCheck2, LockKeyhole, ShieldCheck, WalletCards } from "lucide-react";
...
const trustRecords = [
  { icon: FileCheck2, title: "文件包 hash", text: "资产文件包作为链上索引，用于关联线下鉴定、托管与影像材料。" },
  { icon: LockKeyhole, title: "数字确权", text: "Token ID、持有人地址与状态记录共同形成可追踪的权属凭证。" },
  { icon: ShieldCheck, title: "托管服务", text: "资产可进入第三方托管、保险、安保与跨境流通服务网络。" },
  { icon: WalletCards, title: "流通支持", text: "围绕典当、拍卖、回收等渠道建立更清晰的退出路径。" },
];
